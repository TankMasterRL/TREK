...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.localAdminOnly':
    'A local endpoint (Ollama or LM Studio) is set up once for the whole instance in the admin settings. You can still use your own OpenAI or Anthropic key here.',
