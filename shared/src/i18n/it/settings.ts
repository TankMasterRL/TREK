...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.localAdminOnly':
    "Un endpoint locale (Ollama o LM Studio) si configura una sola volta per l'intera istanza nelle impostazioni di amministrazione. Qui puoi comunque usare la tua chiave OpenAI o Anthropic.",
