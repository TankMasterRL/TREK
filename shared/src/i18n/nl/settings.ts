...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.localAdminOnly':
    'Een lokaal endpoint (Ollama of LM Studio) wordt eenmalig voor de hele instantie ingesteld in de beheerinstellingen. Je kunt hier nog steeds je eigen OpenAI- of Anthropic-sleutel gebruiken.',
