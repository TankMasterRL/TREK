...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.localAdminOnly':
    "Un point de terminaison local (Ollama ou LM Studio) se configure une seule fois pour toute l'instance dans les paramètres d'administration. Vous pouvez toujours utiliser votre propre clé OpenAI ou Anthropic ici.",
